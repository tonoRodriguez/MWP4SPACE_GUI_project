...
def mode_analysis(waveguide_w,angle,boundry,rad,wl):
    ...
    mode1.addrect(name="LN_core1",x = centered_x, x_span=width_film_x,
    		 y = centered_y, y_span=width_film_y, z_min = centered_z,
    		 z_max= centered_z+ LN_hight_sub, material = "Al2O3_SE" )
    centered_z=centered_z+LN_hight_sub
    
    mode1.addrect(name="SiO2_cladding_top",x = centered_x, x_span=width_film_x,
    		 y = centered_y, y_span=width_film_y, z_min = centered_z,
    		 z_max= centered_z+ 2*LN_hight_sub, material = "SiO2_fusedquartz" )
    ...
    mode1.addpoly(x = 0, y =0, z = centered_z, first_axis = "y"
    		, rotation_1 =-90, z_span = width_film_y, material = "Al2O3_SE" , vertices = V )
    ...
    if rad !=0:
        ...
        mode1.addfde(solver_type = "2D X normal" , x = 0.5*2e-6, y = 0, y_span = 4.5e-6,
        		...
        		n1 = 2.1, n2 = 1.5, bent_waveguide = 1, bend_radius = rad )
        ...
        mode1.addfde(solver_type = "2D X normal" , x = 0.5*2e-6, y = 0, y_span = 4.5e-6,
        		...
        		define_z_mesh_by = "maximum mesh step", dz = 100e-9,
        		wavelength = wl, number_of_trial_modes = 50, search = "in range",
        		n1 = 2.1, n2 = 1.5, bent_waveguide = 0)
...
def rad_analysis(rad_min,rad_max,points, angle,boundry,width,wl):
    ...
    mode1.addrect(name="AlO_SE_core1",x = centered_x, x_span=width_film_x,
    		 y = centered_x, y_span=width_film_y, z_min = centered_z,
    		 z_max= centered_z+ LN_hight_sub, material = "Al2O3_SE" )
    centered_z=centered_z+LN_hight_sub
    ...
    mode1.addpoly(x = 0, y =0, z = centered_z, first_axis = "y"
    		, rotation_1 =-90, z_span = width_film_y, material = "Al2O3_SE" , vertices = V ,name ='AlO_core2')
    ...
    mode1.addfde(solver_type = "2D X normal" , x = 0.5*2e-6, y = 0, y_span = 4.5e-6,
    		...
    		define_z_mesh_by = "maximum mesh step", dz = 100e-9,
    		wavelength = wl, number_of_trial_modes = 50, search = "in range",
    		n1 = 1.8, n2 = 1.5, bent_waveguide = 0)
...
#mode_analysis(0.4e-6, 85,"Metal",0,0.5e-6)
