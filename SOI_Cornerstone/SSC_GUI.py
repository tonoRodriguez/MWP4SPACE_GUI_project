...
button_SSC.grid(row=11, columnspan=2)

tk.Label(root, text = "MMi analysis",font=("Helvetica", 10, "bold")).grid(row=12, column=0)
# ancho y largo

tk.Label(root, text="MMi width um:").grid(row=13, column=0)
MMi_width_entry = tk.Entry(root)
MMi_width_entry.grid(row=13, column=1)


# Crear y colocar la entrada para el ancho
tk.Label(root, text="MMi length um:").grid(row=14, column=0)
MMi_length_entry = tk.Entry(root)
MMi_length_entry.grid(row=14, column=1)

# Crear y colocar la entrada para el ancho
tk.Label(root, text="Distance between ports um:").grid(row=15, column=0)
MMi_distance = tk.Entry(root)
MMi_distance.grid(row=15, column=1)
...
button.grid(row=16, columnspan=2)
root.mainloop()
